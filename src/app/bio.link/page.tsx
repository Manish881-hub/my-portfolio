        ...
        <div className="min-h-screen transition-colors duration-300 bg-gray-50">
            <div className="max-w-xl mx-auto min-h-screen flex flex-col py-8 px-4 relative">
                ...
                <div className="absolute top-6 right-6 flex gap-3 z-10">
                    <button
                        onClick={handleShare}
                        className="p-2.5 rounded-full bg-white text-gray-600 shadow-sm hover:shadow-md transition-all border border-gray-100 relative"
                        aria-label="Share"
                    >
                ...
                <div className="flex items-center justify-center gap-5 mb-10">
                    <a href={PROFILE.socials.twitter} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-black transition-all hover:scale-110 transform duration-200 p-2 hover:bg-gray-100 rounded-full">
                    ...
                    <a href={PROFILE.socials.linkedin} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-blue-600 transition-all hover:scale-110 transform duration-200 p-2 hover:bg-blue-50 rounded-full">
                    ...
                    <a href={PROFILE.socials.github} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-black transition-all hover:scale-110 transform duration-200 p-2 hover:bg-gray-100 rounded-full">
                    ...
                    <a href={`mailto:${PROFILE.email}`} target="_blank" rel="noreferrer" className="text-gray-500 hover:text-red-500 transition-all hover:scale-110 transform duration-200 p-2 hover:bg-red-50 rounded-full">
                        <Mail size={24} />
                    </a>
                </div>
                        ...
                        {BIO_LINKS.map((link, idx) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        className="flex items-center justify-center gap-3 rounded-[18px] py-5 px-6 bg-white border border-black/90 shadow-sm hover:shadow-md transition-shadow duration-200"
                                        role="button"
                                    ...
                                    >
                                        ...
                                        <span className="text-center text-gray-900 font-medium tracking-wide text-sm md:text-base">
                                            {link.label}
                                        </span>
                                    </div>
                                </motion.div>
                ...
                <div className="mt-auto text-center pt-8">
                    <a href="/" className="inline-flex items-center gap-2 text-sm font-bold text-gray-300 hover:text-gray-500 transition-colors uppercase tracking-widest">
